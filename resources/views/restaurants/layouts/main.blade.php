...
<head>
    ...
    <title>Dashboard restaurant {{ Auth::user()->firstname }}
    </title>
...
<body class="horizontal-layout horizontal-menu  navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="">
    ...
    <!-- END: Page Vendor JS-->
    <script src="{{ asset('dasboard/app-assets/vendors/js/forms/validation/jquery.validate.min.js') }}"></script>
    <!-- BEGIN: Theme JS-->
    ...
    <script src="{{asset('ashboard/app-assets/vendors/js/tables/datatable/pdfmake.min.js')}}"></script>
