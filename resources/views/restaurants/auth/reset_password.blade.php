                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <form class="auth-reset-password-form mt-2" action="{{ route('restaurant.resetPassword') }}" method="POST">
                                ...
                                <div class="mb-1">
                                    <div class="d-flex justify-content-between">
                                        <label class="form-label" for="reset-password-confirm">Confirmer mot de  passe</label>
                                    </div>
                                    <div class="input-group input-group-merge form-password-toggle">
                                ...
                                <button class="btn btn-primary w-100" tabindex="3">Changer le mot de passe</button>
                            </form>
