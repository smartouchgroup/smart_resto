                    ...
                    <div class="auth-inner my-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                @endif
                                <form class="auth-login-form mt-2" action="{{ route('restaurant.login') }}" method="POST">
                                    @csrf
                                    <div class="mb-1">
                                        <label for="login-email" class="form-label">Email</label>
                                        <input type="text" class="form-control" id="login-email" name="email" placeholder="exemple@gmail.com" aria-describedby="login-email" tabindex="1" autofocus />
                                        @error('email')
