                            ...
                            <div class="card-body">
                                ...
                                <form class="auth-forgot-password-form mt-2" action="{{ route('restaurant.sendLink') }}"
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" name="email" id="forgot-password-email"
                                            name="forgot-password-email" placeholder="example@gmail.com"
                                ...
                                <p class="text-center mt-2">
                                    <a href="{{ route('restaurant.login') }}"> <i data-feather="chevron-left"></i>Page de
                                        connexion</a>
                                </p>
                            </div>
                        </div>
