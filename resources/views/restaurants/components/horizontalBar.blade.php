    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border container-xxl" role="navigation" data-menu="menu-wrapper" data-menu-type="floating-nav">
        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class=" nav-link d-flex align-items-center" href="{{ asset('restaurant/categoriesMeals') }}" ><i data-feather="layers"></i><span data-i18n="User Interface">Catégories de plat</span></a>
                </li>
                <li class="dropdown nav-item" data-menu="dropdown"><a class=" nav-link d-flex align-items-center" href="{{ asset('restaurant/dishes') }}" ><i data-feather="layers"></i><span data-i18n="User Interface">Ajouter un Plat </span></a>
                </li>
                <li class="dropdown nav-item" data-menu="dropdown"><a class=" nav-link d-flex align-items-center" href="{{ asset('restaurant/menu') }} " ><i data-feather="edit"></i><span data-i18n="User Interface">Menu</span></a>
                </li>
