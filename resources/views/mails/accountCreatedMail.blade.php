                                ...
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    <a href="https://unlayer.com" target="_blank">
                                      <img align="center" border="0" src="{{asset('images/mail_images/image-5.png')}}" alt="Logo" title="Logo"
                            ...
                            <td
                              ...
                              <div style="color: #333333; line-height: 190%; text-align: left; word-wrap: break-word;">
                                <p style="line-height: 190%; text-align: left; font-size: 14px;"><span
                                    ...
                                    comme un utilisateur de l'application <strong><em>SmartResto</em></strong>&nbsp;par
                                    {{$organization}}. Voici l'ultime &eacute;tape en deux temps pour pouvoir acc&eacute;der &agrave;
                                    votre compte:</span></p>
                                <p style="line-height: 190%; text-align: left; font-size: 14px;">&nbsp;</p>
                                <p style="font-size: 14px; line-height: 190%;"><strong><span
                                      style="font-size: 18px; line-height: 34.2px;"><span
                                        style="font-size: 22px; line-height: 41.8px;">Etape 1:</span> Code</span><span
                                      style="font-size: 18px; line-height: 34.2px;"> identifiant</span></strong></p>
                                <p style="font-size: 14px; line-height: 190%;"><span
                                    style="font-size: 18px; line-height: 34.2px;">Veuillez acc&eacute;der &agrave; l'un
                                    des liens suivants puis entrez votre&nbsp;<em>code identifiant:&nbsp;</em></span>
                                </p>
                                <p style="font-size: 14px; line-height: 190%;"><span
                                    style="font-size: 18px; line-height: 34.2px;"><em>&nbsp; &nbsp;
                                      &nbsp;&nbsp;<strong>Votre code identifiant:&nbsp;<span
                                          style="font-size: 22px; line-height: 41.8px;">{{$identityCode}}</span></strong></em></span>
                                </p>
                                <p style="font-size: 14px; line-height: 190%;"><span
                                    style="font-size: 18px; line-height: 34.2px;"><span
                                      style="line-height: 34.2px; font-size: 18px;">Lien vers l'application mobile: <a
                                        rel="noopener" href="https://www.google.com"
                                        target="_blank">{{$mobileAppLink}}</a></span></span></p>
                                <p style="font-size: 14px; line-height: 190%;"><span
                                    style="font-size: 18px; line-height: 34.2px;"><span
                                      style="line-height: 34.2px; font-size: 18px;">Lien vers l'application web: <a
                                        rel="noopener" href="https://www.google.com"
                                        target="_blank">{{$webAppLink}}</a></span></span></p>
                                <p style="font-size: 14px; line-height: 190%;">&nbsp;</p>
                                <p style="font-size: 14px; line-height: 190%;"><span
                                    style="font-size: 18px; line-height: 34.2px;"><span
                                      style="line-height: 34.2px; font-size: 18px;"><strong><span
                                          style="font-size: 22px; line-height: 41.8px;">Etape
                                          2:</span></strong>&nbsp;<strong>Connexion &agrave;
                                        l'application</strong></span></span></p>
                                <p style="font-size: 14px; line-height: 190%;"><span
                                    style="font-size: 18px; line-height: 34.2px;"><span
                                ...
                                <p style="font-size: 14px; line-height: 190%;"><span
                                    style="font-size: 18px; line-height: 34.2px;"><span
                                      style="line-height: 34.2px; font-size: 18px;">acc&eacute;der &agrave; votre
                                      interface d'utilisateur:</span></span></p>
                                <p style="font-size: 14px; line-height: 190%;"><strong><span
                                      style="font-size: 18px; line-height: 34.2px;"><span
                                ...
                                <p style="font-size: 14px; line-height: 190%;"><strong><span
                                      style="font-size: 18px; line-height: 34.2px;"><span
                                        style="line-height: 34.2px; font-size: 18px;">Num&eacute;ro de
                                        t&eacute;l&eacute;phone: <em>{{$phone}}</em></span></span></strong></p>
                                <p style="font-size: 14px; line-height: 190%;"><strong><span
                                      style="font-size: 18px; line-height: 34.2px;"><span
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="{{ asset('images/mail_images/image-1.jpeg') }}" alt="border" title="border"
                                      style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;"
                                      width="600" class="v-src-width v-src-max-width" />
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href="https://facebook.com/" title="Facebook" target="_blank">
                                            <img src="{{ asset('images/mail_images/image-6.png') }}" alt="Facebook" title="Facebook" width="32"
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href="https://linkedin.com/" title="LinkedIn" target="_blank">
                                            <img src="{{ asset('images/mail_images/images/image-3.png') }}" alt="LinkedIn" title="LinkedIn" width="32"
                                              style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                          </a>
                                        </td>
                                      </tr>
                          ...
                          <tr>
                            <td
                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 190%;">Tout droit r&eacute;serv&eacute;. Smart
                                  Touch Group<br />Rue 12.22, Immeuble 2&egrave;me Etage</p>
                                <p style="font-size: 14px; line-height: 190%;">Secteur 12, Nemnin,
                                  Ouagadougou<br /><span
                                    style="text-decoration: underline; font-size: 14px; line-height: 26.6px;">Terms of
                                    use</span> | <span
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="{{ asset('images/mail_images/image-4.png') }}" alt="border" title="border"
                                      style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;"
                                      width="600" class="v-src-width v-src-max-width" />
