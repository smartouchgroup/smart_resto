        ...
        <div class="carde rounded">
            <div class="row">
                ...
                <div class="col-10 col-xl-6 mx-auto d-flex flex-column justify-content-center">
                    ...
                    <div class="">
                        <form action="{{ route('employee.login') }}" method="post" class="">
                            @csrf
                          <div class="container">
                            @error('errors')
                      ...
                      @enderror
                            ...
                            <div class="mb-4">
                                <label for="exampleInputPassword1" class="form-label gray_color fw-bold centre">Mot de passe</label>
                                <input type="password" name="password" class="form-control" id="exampleInputPassword1"  placeholder="Entrer votre mot de passe">
                                <div class="text-center mt-2">
                                    <h6 >
                                        <a href="{{ route('forget.password.get')}}" class='gray_color fw-bold'>
                             ...
                             <div class="text-center mt-4">
                                <button type="submit" class="btn bg-primar ">Se connecter</button>
                             </div>
                          </div>
                            </form>
