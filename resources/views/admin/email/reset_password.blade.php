                    ...
                    <div class="auth-inner my-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <p class="card-text mb-1 text-center font-weight-bold">Veuillez entrer vos nouveaux identifiants </p>
                                ...
                                @endif
                                <form class="auth-login-form mt-2" action="submitResetPasswordForm" method="POST">
                                    @csrf
                                    <div class="mb-1">
                                        <input type="hidden" name="token" value="{{ $token }}">
                                        <label for="login-email" class="form-label">Email</label>
                                        <input type="text" class="form-control" id="login-email" name="email" placeholder="example@gmail.com" aria-describedby="login-email" tabindex="1" autofocus required />
                                        @error('email')
                                    ...
                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-label" for="login-password">Confirmer Mot de passe</label>
                                        </div>
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input type="password" class="form-control form-control-merge" id="login-password" name="password" tabindex="2" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="login-password" required />
                                            <span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                                    ...
                                    <button class="btn btn-primary w-100" type="submit" tabindex="4">Changer le mot de passe</button>
                                </form>
                            </div>
                        </div>
                        <!-- /Login basic -->
