                    ...
                    <div class="auth-inner my-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <p class="card-text mb-1 text-center font-weight-bold">Veuillez vous connecter pour avoir accès au panneaux de configuration</p>
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('admin.login') }}" method="POST">
                                    ...
                                    <button class="btn btn-primary w-100" type="submit" tabindex="4">Se connecter</button>
                                </form>
                            </div>
                        </div>
                        <!-- /Login basic -->
