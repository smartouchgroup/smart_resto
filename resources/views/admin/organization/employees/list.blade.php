                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="{{ route('organization.show', $organization->user->uuid) }}">Détails {{
                                        $organization->user->firstname }}</a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{ route('org_employees.index') }}">Liste des
                                        employés</a>
                                </li>
                            </ol>
                        </div>
        ...
        <div class="content-body">
            ...
            <div class="alert alert-danger mt-1 alert-dismissible" role="alert">
                <div class="alert-body d-flex align-items-center">
                    ...
                    <span>Une erreur s'est produite lors de l'ajout d'un employé de la structure {{
                        ...
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <button class="dt-button create-new btn btn-primary" tabindex="0"
                                ...
                                data-bs-target="#modals-slide-in"><span>
                                    ...
                                    </svg>Ajouter un employé</span></button>
                        </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href="{{ route('org_employees.show', $employee->user->uuid) }}">
                                            ...
                                            <a href="{{ route('org_employees.edit', $employee->user->uuid) }}">
                                                @csrf
                                                <button type="submit" class="dropdown-item d-flex align-items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            ...
                                            <button type="button" class="dropdown-item delete__dish__btn" data-bs-toggle="modal" data-bs-target="#deleteModal"  data-route="{{  route('org_employees.destroy', $employee->id) }}">
