                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('org_employees.index') }}">Liste</a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{ route('org_employees.show', $employee->user->uuid) }}">{{$employee->user->firstname . ' ' . $employee->user->lastname}}</a>
                                </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <h5>
                                    {{ $employee->group->name }}
                                    @if ($employee->isChief)
                                        <span class="text-success"> | Chef</span>
                                    @endif
                                </h5>
                            </div>
                            <div class="col-12">
