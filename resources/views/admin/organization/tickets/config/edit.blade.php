    ...
    <div class="row">
        <div class=" offset-3 col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('adminTickets.update',$dataTicket->user->uuid) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-12 mb-2">
                                <div class="mt-1 p-1 border rounded text-center" style="width: fit-content;">
                                    ...
                                    @if (stristr($dataTicket->user->profile, 'avatar.png'))
                                    <img src="{{ asset('storage/avatars/restaurant_avatar.png') }}" class="mx-auto"
                                        height="100" width="100" alt="{{ $dataTicket->user->firstname }}">
                                    @else
                                    <img src="{{ asset('storage/avatars/' . $dataTicket->user->profile) }}"
                                        class="mx-auto" height="100" width="100" alt="{{ $dataTicket->user->firstname }}">
                                    @endif
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="number"  class="form-control" value="{{ $dataTicket->ticketNumber }}" name="ticketNumber" placeholder="Entrer le nombre de ticket total mensuel" />
                                    </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="number" class="form-control" value="{{ $dataTicket->ticketPrice }}" name="ticketPrice" placeholder="Entrer le prix total mensuel "/>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="number"  class="form-control" value="{{ $dataTicket->allowedDishPerDay }}" name="allowedDishPerDay" placeholder="Entrer le nombre de ticket journalier autorisé" />
                                        </div>
