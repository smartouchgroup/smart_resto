                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('org_groups.index') }}">Liste des
                                        groupes</a>
                                </li>
                            </ol>
                        </div>
        ...
        <div class="content-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <a href="{{ route('org_groups.show', $group->id) }}">
                                            ...
                                            <a href="{{ route('org_groups.edit', $group->id) }}">
                                                @csrf
                                                <button type="submit" class="dropdown-item d-flex align-items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            ...
                                            <button type="button" class="dropdown-item delete__dish__btn" data-bs-toggle="modal" data-bs-target="#deleteModal"  data-route="{{  route('org_groups.destroy', $group->id) }}">
            ...
            <div class="modal modal-slide-in fade show" id="modals-slide-in" aria-modal="true">
                <div class="modal-dialog sidebar-sm">
                    <form action="{{route('org_groups.store')}}" method="post" class="add-new-record modal-content pt-0">
                        @csrf
