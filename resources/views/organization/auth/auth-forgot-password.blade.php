                            ...
                            <div class="card-body">
                                ...
                                <form class="auth-forgot-password-form mt-2" action="{{ route('forget.password') }}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="forgot-password-email" name="email" placeholder="example@gmail.com" aria-describedby="forgot-password-email" tabindex="1" autofocus />
                                    </div>
