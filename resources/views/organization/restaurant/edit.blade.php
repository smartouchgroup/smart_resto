                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('org_restaurants.edit', $restaurant->user->uuid) }}">{{ $restaurant->user->firstname }}</a>
                                    </li>
            ...
            <div class="offset-3 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('org_restaurants.update', $restaurant->user->uuid) }}" method="POST"
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" id="firstname" name="firstname" class="form-control"
                                                ...
                                                value="{{ $restaurant->user->firstname }}" />
                                        </div>
                                        @error('firstname')
                                    ...
                                    <div class="mt-1">
                                        @if (stristr($restaurant->user->profile, 'avatar.png'))
                                            <img src="{{ asset('storage/avatars/restaurant_avatar.png') }}"
                                                class="me-75" height="100" width="100"
