                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a
                    ...
                    <ul class="dropdown-menu" data-bs-popper="none">
                        <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                href="{{ route('org.home') }}" data-bs-toggle="" data-i18n="Analytics"><i
                                    data-feather="activity"></i><span data-i18n="Analytics">Home</span></a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown nav-item" data-menu="dropdown"><a class=" nav-link d-flex align-items-center"
                        href="{{ asset('/org/tickets') }}"><i data-feather="layers"></i><span
                            data-i18n="User Interface">Configuration Ticket</span></a>
                </li>
                <li class="dropdown nav-item" data-menu="dropdown"><a class=" nav-link d-flex align-items-center"
                        href="{{ asset('/org/groups') }}"><i data-feather="layers"></i><span
                            data-i18n="User Interface">Groupe</span></a>
                </li>
                {{-- <li class="dropdown nav-item" data-menu="dropdown"><a class=" nav-link d-flex align-items-center"
                        href="{{ asset('admin/{org}/employees') }}"><i data-feather="edit"></i><span
                            data-i18n="User Interface">Personnels</span></a>
                </li> --}}
                <li class="dropdown nav-item" data-menu="dropdown"><a class=" nav-link d-flex align-items-center"
                        href="{{ asset('org/add_employees') }}"><i data-feather="edit"></i><span
                            data-i18n="User Interface">Personnels</span></a>

                </li>
                <li class="dropdown nav-item" data-menu="dropdown"><a class=" nav-link d-flex align-items-center"
                        href="{{ asset('org/org_restaurants') }}"><i data-feather="edit"></i><span
                            data-i18n="User Interface">Restaurants</span></a>
                </li>
