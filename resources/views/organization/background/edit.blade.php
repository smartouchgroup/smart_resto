                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#"><span class=" <button type="submit" class="btn btn-primary data-submit me-1 my-2"
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Couleur Principale de L'entreprise</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 mb-1 mb-sm-0">
                                        ...
                                        <input class="form-control form-control-lg" value="{{ $background->background }}" name="background" type="color" required  />
                                    </div>
                                ...
                                <button type="submit" class="btn btn-primary data-submit me-1 my-2"
                                @if ($background->background)
                                style="background-color: {{ $background->background }} !important;"
                                @endif>valider</button>
                            </div>
                          </form>
                        </div>
                    </div>
