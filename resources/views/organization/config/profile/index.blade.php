                    ...
                    <div class="card-body">
                        <div>
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <h4>Structure - {{ Auth::user()->firstname }}</h4>
                                </div>
                                <div class="col-12">
                                    <div class="mb-1">
                                ...
                                <div class="col-md-6">
                                    <form action="{{ route('organizationProfile') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                ...
                                <div class="col-md-6">
                                    <form action="{{ route('organizationName') }}" method="post">
                                        @csrf
                                ...
                                <div class="col-md-6 my-2">
                                    <form action="{{ route('organizationPhone') }}" method="post">
                                        @csrf
                                ...
                                <div class="col-md-6 my-2">
                                    <form action="{{ route('organizationEmail') }}" method="post">
                                        @csrf
